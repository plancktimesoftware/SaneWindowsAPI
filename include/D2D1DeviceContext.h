...
#define D2D1DEVICECONTEXT_VERSIONS (0, 1, 2, 3, 4, 5)
#elif NTDDI_VERSION >= 0x0A000002//NTDDI_WIN10_RS1
#define D2D1DEVICECONTEXT_VERSIONS (0, 1, 2, 3, 4)
#elif NTDDI_VERSION >= 0x0A000001//NTDDI_WIN10_TH2
#define D2D1DEVICECONTEXT_VERSIONS (0, 1, 2, 3)
#else
#define D2D1DEVICECONTEXT_VERSIONS (0, 1, 2)
#endif
	...
	private:
		DECLARE_VERSIONED_POINTER_VARIABLES(D2D1DEVICECONTEXT_VERSIONS, NUM(D2D1DEVICECONTEXT_VERSIONS), ID2D1DeviceContext, mDeviceContext, nullptr)
	};
	...
	inline void DeviceContext::SetNative(D2D1DeviceContextT* dcPtr)
	{
		...
		QUERY_INTERFACE_VERSIONED_VARIABLES(D2D1DEVICECONTEXT_VERSIONS, NUM(D2D1DEVICECONTEXT_VERSIONS), mDeviceContext, dcPtr, /*no return*/);
		dcPtr->Release();
	}
}
}
